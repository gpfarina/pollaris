...
public class MultiThreadedPollerManager implements PollerManager{
    ...
    public MultiThreadedPollerManager(Config configuration,Scheduler scheduler){
    ...
    public void killPollers() {
        throw new UnsupportedOperationException("Unimplemented method 'killPollers'");
    }

    @Override
    public void startPoller(PollerId id) {
        throw new UnsupportedOperationException("Unimplemented method 'startPoller'");
    }

    @Override
    public void killPoller(PollerId id) {
        throw new UnsupportedOperationException("Unimplemented method 'killPoller'");
    }
